...
public class SettingFragment extends Fragment {
    ...
    private void initRVAdapter() {
        ...
        SettingItem schulteItem = new SettingItem(R.drawable.cognitive_game, "舒尔特方格 5×5模式", 0, true);
    ...
    private void showLogoutConfirmDialog() {
        ...
        Drawable background = ContextCompat.getDrawable(requireContext(), R.drawable.cognitive_background_rounded);
        if (background != null) {
