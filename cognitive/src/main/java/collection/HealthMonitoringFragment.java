...
public class HealthMonitoringFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        List<HealthMonitoringRVModel> list = new ArrayList<>();
        list.add(new HealthMonitoringRVModel("Activity Level", 8234, 10000, "steps")); // TODO
        list.add(new HealthMonitoringRVModel("Sleep Estimation", 7.2, 10, "hours"));
        list.add(new HealthMonitoringRVModel("Rest Heart Rate", 64, 80, "bpm/min"));
        list.add(new HealthMonitoringRVModel("Blood Pressure", 71, 90, "mmHg"));

        HealthMonitoringRVAdapter adapter = new HealthMonitoringRVAdapter(list);
